...
1. `01-init-local.cmd` — создать локальные настройки.
2. `02-start.cmd` — запустить ИИ-сервис в фоне.
3. `03-status.cmd` — проверить состояние.
4. `04-stop.cmd` — остановить ИИ-сервис.

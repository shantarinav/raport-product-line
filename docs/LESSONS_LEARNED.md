...
## 2. Браузерная архитектура дисциплинирует работу с данными

Если приложение не отправляет исходные файлы на сервер, приходится явно проектировать границы хранения, снимки и локальной истории.
...
Локальный ИИ полезен для черновиков и классификации, но базовый дашборд должен оставаться работоспособным без модели и серверной части.

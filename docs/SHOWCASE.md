...
- **ИТ-директор / руководитель цифровизации** — проверить цифровой сценарий до дорогой интеграции.
...
Базовый Рапорт — статическое веб-приложение. Он работает без обязательной серверной части, авторизации, серверной базы и сетевой отправки исходных отчетов.
...
Ключевое решение: сначала доказать ценность сценария в локальном режиме, а не преждевременно строить серверную платформу с пользователями, ролями и общей базой.
...
- роли, пользователей и авторизацию в локальной версии;
- централизованное корпоративное хранилище;
- обязательную серверную часть для базовых дашбордов.
...
- общий набор компонентов интерфейса;
- расчеты отделены от React-компонентов;
- страницы дашбордов загружаются отложенно;
- тесты расчетов, импорта, A3 и ИИ-интеграции;
- сборка для публикации перед размещением;
- журнал архитектурных решений;
- синтетические данные для демонстрации и проверки.

## Что показывает проект

Рапорт демонстрирует не только умение написать код, но и инженерное мышление уровня ИТ-директора:

- выделять управленческую проблему;
- держать границы задачи;
...
- сопровождать проект документацией, журналом решений, выпусками и визуальным контрактом.

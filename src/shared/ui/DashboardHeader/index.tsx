    ...
    <Card className={cn("mb-4", className)}>
      <CardHeader className="flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 sm:flex-1">
          <CardTitle className="text-2xl font-extrabold text-raport-text md:text-3xl">{title}</CardTitle>
          {slogan ? <p className="mt-2 text-sm font-bold text-raport-primary">{slogan}</p> : null}

...
const EXCESS_KEYWORDS: Array<{ category: string; label: string; pattern: RegExp }> = [
  ...
  },
  {
    ...
    label: "хобби и быт",
    pattern:
      /рецепт|меню|вязани|выкройк|путеводител|кулинари|тренировк|фитнес|йог[аиу]?|диет|гороскоп|астрологи|анекдот|ноты|аккорд|ремонт|дач[аеиу]|рассад|рыбалк|охот[ауы]|путешеств|билеты\s+на|(?:^|[^а-яёa-z0-9])тур(?:$|[^а-яёa-z0-9])/iu,
  },
  {
    category: "Личные тематики",
